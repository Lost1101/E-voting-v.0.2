    ...
    if(addopt($_POST) > 0 ){
        echo "
            <script>
                ...
                document.location.href = 'voteoption.php?id=$nmvt';
            </script>
            ";
    }else{
        echo "
            <script>
                ...
                document.location.href = 'newoption.php';
            </script>
        ";
    }
        ...
        <div class="container">
            ...
            <input type="hidden" name="id">
                ...
                <div class="d-flex flex-wrap justify-content-between">
                    ...
                    <button class="btn btn-outline-light" type="submit" name="create">Add</button>
            </form>
            </div>
        </div>
    </div>
